...
| Metric | Value |
|--------|-------|
| **Total Execution Time** | 267201 ns (0.267 ms) |
| **Throughput** | **3742501 launches/sec** |
| **Average Latency** | **0.27 µs per launch** |
| Minimum Theoretical Latency | 267.20 ns per launch |

## Latency Breakdown

Average time per kernel launch operation:

- **Total overhead**: 0.27 µs
...
- Throughput of **3.7M launches/sec** shows minimal protocol overhead
